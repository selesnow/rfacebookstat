...
* *action_breakdowns* - Разбивки по действиям, более подробно о них можно узнать в [документации](https://developers.facebook.com/documentation/ads-commerce/marketing-api/insights/breakdowns#actionsbreakdown) к API Facebook, так же более подробно они будут рассмотрены позже в этой виньетке.
* *breakdowns* - Общие разбивки которые предоставляют дополнительные возможности по группировке данных, подробности в [документации](https://developers.facebook.com/documentation/ads-commerce/marketing-api/insights/breakdowns#ageandgender) к API Facebook, так же этот аргумент будет более подробно рассмотрен немного ниже.
* *fields* - Поля которые вы хотите загрузить из API, полный список всех полей доступен по [ссылке](https://developers.facebook.com/documentation/ads-commerce/marketing-api/reference/ad-account/insights).
...
Актуальный список группировок всегда можно найти в официальной документации API Facebook по [ссылке](https://developers.facebook.com/documentation/ads-commerce/marketing-api/insights/breakdowns#ageandgender).
...
* [API Insights / Статистика / Окна атрибуции](https://developers.facebook.com/documentation/ads-commerce/marketing-api/insights#sample)
* [Система правил для рекламы](https://developers.facebook.com/documentation/ads-commerce/marketing-api/ad-rules)
...
В API Facebook на данный момент существует 2 уровня доступа к API ([раздел в справке](https://developers.facebook.com/documentation/ads-commerce/marketing-api/get-started/authorization) API Facebook):

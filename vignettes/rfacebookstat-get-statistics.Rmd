...
vignette: >
  %\VignetteIndexEntry{Загрузки статистики из рекламных аккаунтов Facebook}
...
* [Система правил для рекламы](https://developers.facebook.com/docs/marketing-api/ad-rules-getting-started/)

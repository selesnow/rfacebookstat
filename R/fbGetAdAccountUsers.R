fbGetAdAccountUsers <- function(accounts_id = NULL ,
  ...
  for(account in accounts_id){
    ...
    QueryString <- paste0("https://graph.facebook.com/",api_version,"/",account,"/userpermissions?fields=user,business_persona,tasks,email,status&limit=150&access_token=",access_token)
